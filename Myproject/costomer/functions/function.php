...
//getting the defilt of function
...

{
    ...
    $row_c=mysqli_fetch_array($run_c);
        ...
        if(!isset($_GET['delet_account'])){
         ...
         $get_addres="select * from customer_order where customer_id='$customer_id' and order_status='pending'";
         $run_order=mysqli_query($db,$get_addres);
         ...
         if($count_order>0)
         {
            ...
            <h2>yuoe have ($count_order) pendin order</h2>
            <h3>plese are you order detail by clicking this<a href='my_account.php?my_order'>LINK</a><br> or you can pay<a href='pay_offline.php' target='_blank'>pay offline now</a></h3>
         ...
         else
         {
            echo "<div style='padding:10px;'>
            <h1 style='color:red; text-decoration:underline;'>important</h1>
            <h2>you have  no pendin order</h2>
            <h3> you ca see order history by clicking this<a href='my_account.php?my_order'>LINK</a></h3>
...
{
    $q="INSERT INTO `cart`(`p_id`, `ip_addres` ) VALUES ('$p_id','$ip_addres')";
...
function items()
{
    ...
    if(isset($_GET['add_cart']))
    {
        ...
        $get_items= "select * from cart where ip_addres='$ip_addres'";
